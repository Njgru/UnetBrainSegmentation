...
train_subjects = brats_subjects[0:100]
test_subjects = brats_subjects[100:]
...
with torch.no_grad():
    for x in brats_data_loader:
        ...
        transformed_batch_subject_brat.save(f'output\\{new_name}.nii.gz')